...
public class User extends PKEntity<Long> {
	...
	public String toString() {
		return "User [id=" + getId() + ", avatar=" + avatar + ", captcha=" + captcha + ", description=" + description + ", email=" + email + ", encrypt=" + encrypt + ", isOnline=" + isOnline + ", lastloginip=" + lastloginip + ", lastlogintime=" + lastlogintime + ", password=" + password + ", phone=" + phone + ", realName=" + realName + ", regtime=" + regtime + ", save=" + save + ", username=" + username + ", wechat=" + wechat + ", wechatName=" + wechatName + "]";
	}
