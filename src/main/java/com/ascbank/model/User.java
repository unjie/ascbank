...
public class User extends PKEntity<Long> {
	...
	@NotEmpty(groups = { LoginCheck.class, AddCheck.class }, message = "密码不能为空")
	@Length(min = 6, max = 18, message = "密码必须为6-18位", groups = { LoginCheck.class })
	 ...
	 *
	 * @mbggenerated Wed Jul 13 16:52:44 CST 2016re
	 */
	...
	public String toString() {
		return "User [avatar=" + avatar + ", description=" + description + ", email=" + email + ", encrypt=" + encrypt + ", isOnline=" + isOnline + ", lastloginip=" + lastloginip + ", lastlogintime=" + lastlogintime + ", password=" + password + ", phone=" + phone + ", realName=" + realName + ", regtime=" + regtime + ", roles=" + roles + ", username=" + username + ", wechat=" + wechat + ", wechatName=" + wechatName + ", Id=" + getId() + "]";
	}
