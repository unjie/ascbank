...
public abstract class AbstractLimitHandler implements LimitHandler {
	 ...
	 * <p/>
	 * NOTE: what gets passed into {@link AbstractLimitHandler#processSql(String, org.hibernate.engine.spi.RowSelection)} is the zero-based offset. Dialects which do not {@link #supportsVariableLimit} should take care to perform any needed first-row-conversion calls prior to injecting the limit values into the SQL string.
	 *
	 ...
	 */
	protected final int getMaxOrLimit(Pageable selection) {
