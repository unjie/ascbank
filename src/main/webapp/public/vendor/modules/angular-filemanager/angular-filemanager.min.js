!function(e, r, n) {
    "use strict";
    r.module("FileManagerApp", ["pascalprecht.translate", "ngFileUpload"]),
    n(e.document).on("shown.bs.modal", ".modal", function() {
...
function(e, r) {
    ...
    e.module("FileManagerApp").controller("FileManagerCtrl", ["$scope", "$rootScope", "$window", "$translate", "fileManagerConfig", "item", "fileNavigator", "apiMiddleware", function(e, n, i, a, t, o, s, l) {
        ...
        e.uploadFileList = [],
        e.viewTemplate = d.getItem("viewTemplate") || "main-icons.htm",
        e.fileList = [],
        e.temps = [],
        e.$watch("temps", function() {
        ...
        e.changeLanguage = function(e) {
            return e ? (d.setItem("language", e),
            a.use(e)) : void a.use(d.getItem("language") || t.defaultLang)
        }
        ,
        e.isSelected = function(r) {
            return e.temps.indexOf(r) !== -1
        }
        ,
        ...
        e.smartClick = function(r) {
            ...
            if (r.isFolder())
                return e.fileNavigator.folderClick(r);
        ...
        e.openImagePreview = function() {
            ...
            e.modal("imagepreview", null , !0).find("#imagepreview-target").attr("src", e.apiMiddleware.getUrl(r)).unbind("load error").on("load error", function() {
        ...
        e.openEditItem = function() {
            ...
            e.apiMiddleware.getContent(r).then(function(e) {
                r.tempModel.content = r.model.content = e.data
            }),
            e.modal("edit")
        }
        ,
        ...
        e.download = function() {
            ...
            if (!e.selectionHas("dir"))
                return r ? e.apiMiddleware.download(r) : e.apiMiddleware.downloadMultiple(e.temps)
        }
        ,
        e.copy = function() {
            var r = e.singleSelection();
            if (r) {
                ...
                if (t && c(r))
                    return e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename"),
                    !1;
                if (!i)
                    return e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename"),
                    !1
        ...
        e.compress = function() {
            ...
            return i && c(e.temp) ? (e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename"),
            !1) : r ? void e.apiMiddleware.compress(e.temps, r, n.selectedModalPath).then(function() {
                return e.fileNavigator.refresh(),
                e.config.compressAsync ? void (e.apiMiddleware.apiHandler.asyncSuccess = !0) : e.modal("compress", !0)
            }, function() {
                e.apiMiddleware.apiHandler.asyncSuccess = !1
            }) : (e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename"),
            !1)
        }
        ,
        e.extract = function() {
            var r = e.temp
              ...
              , t = e.fileNavigator.fileNameExists(i);
            return t && c(e.temp) ? (e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename"),
            !1) : i ? void e.apiMiddleware.extract(r, i, n.selectedModalPath).then(function() {
                return e.fileNavigator.refresh(),
        ...
        e.move = function() {
            ...
            return r && c(r) ? (e.apiMiddleware.apiHandler.error = a.instant("error_cannot_move_same_path"),
            !1) : void e.apiMiddleware.move(e.temps, n.selectedModalPath).then(function() {
                e.fileNavigator.refresh(),
                e.modal("move", !0)
            })
        }
        ...
        e.rename = function() {
            ...
            return !n || i && e.fileNavigator.fileNameExists(n) ? (e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename"),
            !1) : void e.apiMiddleware.rename(r).then(function() {
                e.fileNavigator.refresh(),
                e.modal("rename", !0)
            })
        }
        ...
        e.uploadFiles = function() {
            e.apiMiddleware.upload(e.uploadFileList, e.fileNavigator.currentPath).then(function() {
                ...
                var n = r.data && r.error || a.instant("error_uploading_files");
...
function(e) {
    ...
    e.module("FileManagerApp").controller("ModalFileManagerCtrl", ["$scope", "$rootScope", "fileNavigator", function(e, r, n) {
        ...
        ,
        e.select = function(n) {
            r.selectedModalPath = n.model.fullPath().split("/"),
            e.modal("selector", !0)
        }
        ,
...
function(e) {
    ...
    r.directive("angularFilemanager", ["$parse", "fileManagerConfig", function(e, r) {
        return {
            restrict: "EA",
            templateUrl: r.tplPath + "/main.htm"
        }
    }
    ]),
        ...
        var i = function(r, i) {
            function a(e) {
              //  var r = (e || "").toString().split(/[- :]/);
            	var d=new Date();
            	d.setTime(e);
                return d;//(r[0],r[1] - 1,r[2],r[3],r[4],r[5])
            }
            var t = {
                name: r && r.name || "",
                path: i || [],
...
function(e) {
    ...
    e.module("FileManagerApp").provider("fileManagerConfig", function() {
        var r = {
            ...
            tplPath: "public/vendor/modules/angular-filemanager/templates"
        };
        return {
            $get: function() {
                return r
...
function(e, r) {
    ...
    e.module("FileManagerApp").service("apiHandler", ["$http", "$q", "$window", "$translate", "Upload", function(e, n, i, a, t) {
        ...
        return o.prototype.deferredHandler = function(e, r, n, i) {
            ...
            e.data && e.error && (this.error = e.error),
            !this.error && e.error && (this.error = e.message),
        ...
        o.prototype.copy = function(r, i, t, o) {
          ...
          //      action: "copy",
            ...
            return o && 1 === i.length && (d.toFilename = o),
            s.inprocess = !0,
            s.error = "",
        ...
        o.prototype.upload = function(e, r, i) {
           ...
           // 	, l = 0; l < i.length; l++) s.files.push(i[l]);
        ...
        o.prototype.download = function(r, t, o, s, l) {
            var d = this
              , c = this.getUrl(r, t);
            if (!s || l || !i.saveAs)
                return !i.saveAs && i.console.log("Your browser dont support ajax download, downloading by default"),
                !!i.open(c, "_blank", "");
            var p = n.defer();
        ...
        //        action: "downloadMultiple",
              ...
              , u = [t, r.param(m)].join("?");
            return l && !d && i.saveAs ? (c.inprocess = !0,
            ...
            p.promise) : (!i.saveAs && i.console.log("Your browser dont support ajax download, downloading by default"),
            !!i.open(u, "_blank", ""))
        }
        ,
...
function(e) {
    ...
    e.module("FileManagerApp").service("fileNavigator", ["apiMiddleware", "fileManagerConfig", "item", function(e, r, n) {
        ...
        return i.prototype.deferredHandler = function(e, r, n, i) {
            return e && "object" == typeof e || (this.error = "Error %s - Bridge response error, please check the API docs or this ajax response.".replace("%s", n)),
            404 == n && (this.error = "Error 404 - Backend bridge is not working, please check the ajax response."),
            !this.success && e.data && e.error && (this.error = e.error),
        ...
        i.prototype.refresh = function() {
            var e = this;
            e.currentPath.length || (e.currentPath = r.basePath || []);
            var i = e.currentPath.join("/");
            return e.requesting = !0,
            e.fileList = [],
            e.list().then(function(r) {
                e.fileList = (r.data || []).map(function(r) {
        ...
        i.prototype.buildTree = function(e) {
            function i(e, r, n) {
                var a = n ? n + "/" + r.model.name : r.model.name;
                if (e.name.trim() && 0 !== n.trim().indexOf(e.name) && (e.nodes = []),
                e.name !== n)
            ...
            for (var l in this.fileList) {
                ...
                d instanceof n && d.isFolder() && i(this.history[0], d, e)
            }
        }
        ,
