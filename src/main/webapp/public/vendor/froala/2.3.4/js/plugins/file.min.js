...
!function(a) {
    ...
    a.extend(a.FE.DEFAULTS, {
        ...
        fileUploadURLPrefix:"./file/download/",
    ...
    a.FE.PLUGINS.file = function(b) {
        function c() {
            var a = b.$tb.find('.fr-command[data-cmd="insertFile"]')
              , c = b.popups.get("file.insert")/*, d = a.find(".fr-file-by-url-layer input");
              d.val(""),
        ...
        function h(a, c, d) {
            ...
            b.events.focus(!0),
            b.selection.restore(),
            b.html.insert('<a href="'+ b.opts.fileUploadURLPrefix + a + '" id="fr-inserted-file" class="fr-file">' + (c || b.selection.text()) + "</a>");
        ...
        function p(a) {
            ...
            if ("undefined" != typeof a && a.length > 0) {
                ...
                if (c.size > b.opts.fileMaxSize)
                    return n(C),
                    !1;
                if (b.opts.fileAllowedTypes.indexOf("*") < 0 && b.opts.fileAllowedTypes.indexOf(c.type.replace(/file\//g, "")) < 0)
                    return n(D),
                    !1;
                var e;
                ...
                e) {
                    ...
                    if (b.opts.fileUploadToS3 !== !1) {
                        ...
                        for (f in b.opts.fileUploadToS3.params)
                            b.opts.fileUploadToS3.params.hasOwnProperty(f) && e.append(f, b.opts.fileUploadToS3.params[f])
                    }
                    for (f in b.opts.fileUploadParams)
                        b.opts.fileUploadParams.hasOwnProperty(f) && e.append(f, b.opts.fileUploadParams[f]);
        ...
        function s(a) {
            if (a)
                return b.popups.onHide("file.insert", r), !0;
            var d, c = "";
          ...
          i = '<div class="fr-file-upload-layer' + d + ' fr-layer" id="fr-file-upload-layer-' + b.id + '"><strong>' + b.language.translate("Drop file") + "</strong><br>(" + b.language.translate("or click") + ')<div class="fr-form"><input type="file"  name="' + b.opts.fileUploadParam + '" accept="/*" tabIndex="-1"></div></div>');
          ...
          /*END*/
          // var d = "";
          //  d = '<div class="fr-file-upload-layer'+d+' fr-layer fr-active" id="fr-file-upload-layer-' + b.id + '"><strong>' + b.language.translate("Drop file") + "</strong><br>(" + b.language.translate("or click") + ')<div class="fr-form"><input type="file" name="' + b.opts.fileUploadParam + '" accept="/*" tabIndex="-1"></div></div>';
        ...
        function U(a) {
            ...
            console.log(".fr-" + a + "-layer"),console.log(e.find(".fr-" + a + "-layer")),
        ...
        function ra(a) {
            ...
            c.find(".fr-file-progress-bar-layer").removeClass("fr-active"),
            c.find(".fr-buttons").show(),
            (a || b.$el.find(".fr-error").length) && (b.events.focus(),
            b.$el.find(".fr-error").remove(),
            b.undo.saveStep(),
            b.undo.run(),
            b.undo.dropRedo()))
        }
        function la() {
            var c = b.popups.get("file.insert");
            c || (c = s()),
            b.popups.isVisible("file.insert") || (ra(),
            b.popups.refresh("file.insert"),
            b.popups.setContainer("file.insert", a(b.opts.scrollableContainer)));
        ...
        function ua() {
            ...
            c.val().length > 0 && (d(),s("Loading File"),h(c.val(), c.val(), [], qa),
            c.val(""),
            c.blur())
        }
        var qa
        /*END*/
          ...
          , E = 7
          , F = {};
        return F[y] = "File cannot be loaded from the passed link.",
        ...
        F[E] = "Files can be uploaded only to same domain in IE 8 and IE 9.",
        {
            _init: x,
            showInsertPopup: c,
            showLayer: U,
