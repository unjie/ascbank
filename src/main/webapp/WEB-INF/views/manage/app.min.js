...
.config([ '$ocLazyLoadProvider', function($ocLazyLoadProvider) {
	...
	$ocLazyLoadProvider.config({
		...
		modules : [ {
			...
			name : 'libGantt',
			files : [ 'public/vendor/angular/angular-gantt/dist/angular-gantt.min.css', 'public/vendor/angular/angular-gantt/dist/angular-gantt-plugins.min.css', 'public/vendor/angular/angular-dragdrop/draganddrop.min.js', 'public/vendor/libs/css-element-queries/ElementQueries.js', 'public/vendor/libs/css-element-queries/ResizeSensor.js', 'public/vendor/angular/angular-gantt/angular-gantt.syn.js'
			...
			name : 'textAngular',
			files : [ '//cdn.bootcss.com/textAngular/1.5.12/textAngular.min.css', '//cdn.bootcss.com/textAngular/1.5.12/textAngular-rangy.min.js', '//cdn.bootcss.com/textAngular/1.5.12/textAngular-sanitize.min.js', '//cdn.bootcss.com/textAngular/1.5.12/textAngular.min.js'
			...
			name : 'angular-strap',
			files : [ 'public/vendor/angular/angular-strap/angular-strap.syn.min.js'
			...
			name : 'filemanager',
			files : [ 'public/vendor/modules/angular-filemanager/angular-filemanager.min.css', 'public/vendor/modules/ng-file-upload/ng-file-upload.min.js', 'public/vendor/modules/angular-filemanager/angular-filemanager.min.js', '//cdn.bootcss.com/tether/1.3.7/js/tether.min.js' ]
		}, {
			/* code view editor 代码视图编辑工具js */
			name : 'codemirror',
			files : [ './public/vendor/codemirror/5.3.0/codemirror.min.js', './public/vendor/codemirror/5.3.0/xml.min.js' ]
		}, {
			name : 'froalaEditor',
			files : [ './public/vendor/froala/2.3.4/directive/froala.js', 	'./public/vendor/froala/2.3.4/froalaConfig.js',]
		}, {
			name : 'ckeditor',
			files : [ './public/vendor/ckeditor/4.6.0/directive/ckeditor.js' ]
		}, {
			name : 'uiTinymce',
			files : [ './public/vendor/tinymce/4.4.3/tinymce.min.js', './public/vendor/tinymce/4.4.3/angular-ui-tinymce/src/tinymce.js' ]
		// files : [ './public/vendor/tinymce/4.4.3/directive/uiTinymce.js']
		}
...
.run([ '$rootScope', '$state', '$stateParams', function($rootScope, $state, $stateParams) {
	...
	}).state('app.content.menu', {
		url : '/menu',
		templateUrl : './manage/tpl/content/menu.html',
		resolve : {
			deps : [ '$ocLazyLoad', function($ocLazyLoad) {// 'angular-strap','angular-motion','./public/css/bootstrap-additions/bootstrap-additions.min.css'
				return $ocLazyLoad.load([ 'angular-ui-tree', 'froalaEditor' ]).then(function() {// 'codemirror',
					return $ocLazyLoad.load('./manage/tpl/content/menu.js');
				});
			} ]
		}
	}).state('app.content.article', {
		url : '/article',
		templateUrl : './manage/tpl/content/article.html',
		resolve : {
			deps : [ '$ocLazyLoad', function($ocLazyLoad) {
				return $ocLazyLoad.load([ 'froalaEditor' ]).then(function() {// 'codemirror',froalaEditor
					return $ocLazyLoad.load([ './manage/tpl/content/article.js' ]);
				});
			} ]
		}
	})
	...
	.state('app.ui', {
		...
		resolve : {
			deps : [ '$ocLazyLoad', function($ocLazyLoad) {
				// return $ocLazyLoad.load(['bootstrapJS' ]).then(function() {
				return $ocLazyLoad.load([ './manage/tpl/rest/modalDemoCtrl.js' ]);
				// });
			} ]
		}
