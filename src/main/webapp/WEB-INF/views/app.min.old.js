...
.constant('JQ_CONFIG', {
      ...
      plot:           ['public/vendor/jquery/charts/flot/jquery.flot.min.js', 
                          'public/vendor/jquery/charts/flot/jquery.flot.resize.js',
                          'public/vendor/jquery/charts/flot/jquery.flot.tooltip.min.js',
                          'public/vendor/jquery/charts/flot/jquery.flot.spline.js',
                          'public/vendor/jquery/charts/flot/jquery.flot.orderBars.js',
                          'public/vendor/jquery/charts/flot/jquery.flot.pie.min.js'],
      ...
      nestable:       ['public/vendor/jquery/nestable/jquery.nestable.js',
                          'public/vendor/jquery/nestable/nestable.css'],
      filestyle:      ['public/vendor/jquery/file/bootstrap-filestyle.min.js'],
      slider:         ['public/vendor/jquery/slider/bootstrap-slider.js',
                          'public/vendor/jquery/slider/slider.css'],
      chosen:         ['public/vendor/jquery/chosen/chosen.jquery.min.js',
                          'public/vendor/jquery/chosen/chosen.css'],
      TouchSpin:      ['public/vendor/jquery/spinner/jquery.bootstrap-touchspin.min.js',
                          'public/vendor/jquery/spinner/jquery.bootstrap-touchspin.css'],
      wysiwyg:        ['public/vendor/jquery/wysiwyg/bootstrap-wysiwyg.js',
                          'public/vendor/jquery/wysiwyg/jquery.hotkeys.js'],
      dataTable:      ['public/vendor/jquery/datatables/jquery.dataTables.min.js',
                          'public/vendor/jquery/datatables/dataTables.bootstrap.js',
                          'public/vendor/jquery/datatables/dataTables.bootstrap.css'],
      vectorMap:      ['public/vendor/jquery/jvectormap/jquery-jvectormap.min.js', 
                          'public/vendor/jquery/jvectormap/jquery-jvectormap-world-mill-en.js',
                          'public/vendor/jquery/jvectormap/jquery-jvectormap-us-aea-en.js',
                          'public/vendor/jquery/jvectormap/jquery-jvectormap.css'],
      footable:       ['public/vendor/jquery/footable/footable.all.min.js',
                          'public/vendor/jquery/footable/footable.core.css']
      }
  )
  // oclazyload config
          ...
          modules: [
              {
                  name: 'ngGrid',
                  files: [
                      'public/vendor/modules/ng-grid/ng-grid.min.js',
                      'public/vendor/modules/ng-grid/ng-grid.min.css',
                      'public/vendor/modules/ng-grid/theme.css'
                  ]
              },
              {
            	name: 'moment',
              ...
              },
              {
            	  name: 'libGantt',
            	  files:[
            	         'public/vendor/angular/angular-gantt/dist/angular-gantt.min.css',
            	         'public/vendor/angular/angular-gantt/dist/angular-gantt-plugins.min.css',
            	         
            	         'public/vendor/angular/angular-dragdrop/draganddrop.min.js',
            	         
            	         'public/vendor/libs/css-element-queries/ElementQueries.js',
            	         'public/vendor/libs/css-element-queries/ResizeSensor.js',
              ...
              
              {
            	  ...
            	  files:[
            	         'public/vendor/angular/angular-ui-tree/angular-ui-tree.min.css',
            	         'public/vendor/angular/angular-ui-tree/angular-ui-tree.min.js'
            	         ]
              },
              ...
              
              {
                  name: 'ui.select',
                  files: [
                      'public/vendor/modules/angular-ui-select/select.min.js',
                      'public/vendor/modules/angular-ui-select/select.min.css'
                  ]
              },
              {
                  name:'angularFileUpload',
                  files: [
                    'public/vendor/modules/angular-file-upload/angular-file-upload.min.js'
                  ]
              },
              {
                  name:'ui.calendar',
              ...
              },
              {
                  name: 'ngImgCrop',
                  files: [
                      'public/vendor/modules/ngImgCrop/ng-img-crop.js',
                      'public/vendor/modules/ngImgCrop/ng-img-crop.css'
                  ]
              },
              {
                  name: 'angularBootstrapNavTree',
                  files: [
                      'public/vendor/modules/angular-bootstrap-nav-tree/abn_tree_directive.js',
                      'public/vendor/modules/angular-bootstrap-nav-tree/abn_tree.css'
                  ]
              },
              {
                  name: 'toaster',
                  files: [
                      'public/vendor/modules/angularjs-toaster/toaster.js',
                      'public/vendor/modules/angularjs-toaster/toaster.css'
                  ]
              },
              {
                  name: 'textAngular',
                  files: [
                    //  'public/vendor/modules/textAngular/textAngular-sanitize.min.js',
                     // 'public/vendor/modules/textAngular/textAngular.min.js'
                      '//cdn.bootcss.com/textAngular/1.5.12/textAngular.min.css',
                      '//cdn.bootcss.com/textAngular/1.5.12/textAngular-rangy.min.js',
                      '//cdn.bootcss.com/textAngular/1.5.12/textAngular-sanitize.min.js',
                      '//cdn.bootcss.com/textAngular/1.5.12/textAngular.min.js'
              ...
              },
              {
                  ...
                  files: [
                      'public/vendor/modules/angular-slider/angular-slider.min.js',
                      'public/vendor/modules/angular-slider/angular-slider.css'
                  ]
              },
              {
                  name: 'com.2fdevs.videogular',
                  files: [
                      'public/vendor/modules/videogular/videogular.min.js'
                  ]
              },
              {
                  name: 'com.2fdevs.videogular.plugins.controls',
                  files: [
                      'public/vendor/modules/videogular/plugins/controls.min.js'
                  ]
              },
              {
                  name: 'com.2fdevs.videogular.plugins.buffering',
                  files: [
                      'public/vendor/modules/videogular/plugins/buffering.min.js'
                  ]
              },
              {
                  name: 'com.2fdevs.videogular.plugins.overlayplay',
                  files: [
                      'public/vendor/modules/videogular/plugins/overlay-play.min.js'
                  ]
              },
              {
                  name: 'com.2fdevs.videogular.plugins.poster',
                  files: [
                      'public/vendor/modules/videogular/plugins/poster.min.js'
                  ]
              },
              {
                  name: 'com.2fdevs.videogular.plugins.imaads',
                  files: [
                      'public/vendor/modules/videogular/plugins/ima-ads.min.js'
                  ]
              },
              {
            	  name:'ckeditor',
              ...
              },
              {
            	  name:'bootstrapJS',
            	  files:[
            	         '//cdn.bootcss.com/bootstrap/4.0.0-alpha.4/js/bootstrap.min.js'
            	         ]
              },
              {
            	  name : 'angular-motion',
              ...
              },
              {
            	  name:"jsPlumb",
            	  files:[
            	         '//cdn.bootcss.com/jsPlumb/2.0.7/jsPlumb.min.js'
            	         ]
              },
              {
            	  name:'filemanager',
            	  files:[
            	         'public/vendor/modules/angular-filemanager/angular-filemanager.min.css',
            	   //      '//cdn.bootcss.com/jquery-modal/0.8.0/jquery.modal.min.css',
            	         
            	   //      '//cdn.bootcss.com/jquery-modal/0.8.0/jquery.modal.min.js',
            	         'public/vendor/modules/ng-file-upload/ng-file-upload.min.js',
            	         'public/vendor/modules/angular-filemanager/angular-filemanager.min.js',
            	         '//cdn.bootcss.com/tether/1.3.7/js/tether.min.js'            	         
            	         ]
              },
              {
            	  name:'froalaEditor',
            	  files:[
            	         'public/froala_editor_2.3.4/css/froala_editor.min.css',
            	         'public/froala_editor_2.3.4/css/froala_style.min.css',
            	         
            	         'public/froala_editor_2.3.4/css/plugins/char_counter.css',
            	         'public/froala_editor_2.3.4/css/plugins/code_view.css',
            	         'public/froala_editor_2.3.4/css/plugins/colors.css',
            	         'public/froala_editor_2.3.4/css/plugins/emoticons.css',
            	         'public/froala_editor_2.3.4/css/plugins/file.css',
            	         'public/froala_editor_2.3.4/css/plugins/fullscreen.css',
            	         'public/froala_editor_2.3.4/css/plugins/image_manager.css',
            	         'public/froala_editor_2.3.4/css/plugins/image.css',
            	         'public/froala_editor_2.3.4/css/plugins/line_breaker.css',
            	         'public/froala_editor_2.3.4/css/plugins/table.css',
            	         'public/froala_editor_2.3.4/css/plugins/video.css',
            	         
            	         'public/froala_editor_2.3.4/js/froala_editor.min.js',
            	         
            	         'public/froala_editor_2.3.4/js/plugins/align.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/char_counter.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/code_beautifier.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/code_view.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/colors.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/emoticons.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/entities.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/file.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/font_family.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/font_size.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/fullscreen.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/image.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/image_manager.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/inline_style.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/line_breaker.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/link.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/lists.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/paragraph_format.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/paragraph_style.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/quote.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/save.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/table.min.js',
            	         'public/froala_editor_2.3.4/js/plugins/video.min.js',
      ...
      function ($stateProvider,   $urlRouterProvider) {
          ...
          $stateProvider
              ...
              .state('app.user', {
                  ...
                  resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){//'angular-strap','angular-motion','./public/css/bootstrap-additions/bootstrap-additions.min.css'
              ...
              //<link href="//cdn.bootcss.com/angular-gantt/1.2.11/angular-gantt.min.css" rel="stylesheet">
               .state('app.gantt', {
                  url: '/gantt',
                  templateUrl: "./manage/tpl/gantt/index.html",
                  resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){//'angular-strap',
                    	  return  $ocLazyLoad.load(['moment','angular-ui-tree','libGantt','jsPlumb'])
                    	  .then(function(){
               ...
               .state('app.conent.menu', {
                 ...
                 resolve: {
				      deps: ['$ocLazyLoad',
				      function( $ocLazyLoad ){//'angular-strap','angular-motion','./public/css/bootstrap-additions/bootstrap-additions.min.css'
				       return $ocLazyLoad.load(['angular-ui-tree','froalaEditor']).then(
				           function(){
               ...
               .state('app.conent.article', {
                  ...
                  resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load('froalaEditor').then(
                        	 function(){
              ...
              .state('app.file',{
            	  ...
            	  resolve:{
            		  deps: ['$ocLazyLoad',
                             function( $ocLazyLoad ){
                               return $ocLazyLoad.load(['filemanager','bootstrapJS']).then(
                             	 function(){
                      ...
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load( [
                            'public/js/app/map/load-google-maps.js',
                            'public/js/app/map/ui-map.js',
                            'public/js/app/map/map.js'] ).then(
                              function(){
              ...
              .state('app.calendar', {
                  ...
                  resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load(
                            ['public/vendor/jquery/fullcalendar/fullcalendar.css',
                              'public/vendor/jquery/fullcalendar/theme.css',
                             // 'moment',
                              'public/vendor/angular/angular-moment/moment.min.js',
                              'public/vendor/jquery/jquery-ui-1.10.3.custom.min.js',
                              'public/vendor/jquery/fullcalendar/fullcalendar.min.js',
                              'public/js/app/calendar/calendar.js']
                          ).then(
                            function(){
                          ...
                          return $ocLazyLoad.load(
                              {
                                  ...
                                  files: ['public/js/app/weather/skycons.js',
                                          'public/vendor/angular/angular-moment/moment.min.js', 
                                          'public/js/app/weather/angular-skycons.js',
                                          'public/js/app/weather/ctrl.js' ] 
                              }
                          );
                      }]
                  }
                      ...
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load([
                            ...
                            'public/js/app/music/ctrl.js', 
                            'public/js/app/music/theme.css'
                          ]);
                      }]
                  }
              })
