...
public class AlerticTest {
	...
	public void articleQueryTest() {
		ArticleMapper am = (ArticleMapper) context.getBean("articleMapper");
		Article record = am.selectByPrimaryKey(1L);
	...
	public void articleDeleteTest() {
		ArticleMapper am = (ArticleMapper) context.getBean("articleMapper");
		Long record = am.deleteByPrimaryKey(1L);
